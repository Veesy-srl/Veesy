...
namespace Veesy.Domain.Migrations
{
    ...
    [Migration("20230911100041_AddITrackToAllTables")]
    partial class AddITrackToAllTables
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Veesy.Domain.Models.TmpMedia", b =>
                {
                    b.HasOne("Veesy.Domain.Models.Media", "Media")
                        .WithOne("TmpMedia")
                        .HasForeignKey("Veesy.Domain.Models.TmpMedia", "MediaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
